class HomeController < ApplicationController
 ...
 @jobprofiles = Jobprofile.all.page(params[:page])
    ...
    @hash = Gmaps4rails.build_markers( @jobprofiles) do |jobprofile, marker|
     ...
     @info =  @info = '<center><h1><i class="fas fa-user-tie"></i></h1></center>'"<strong>Name of Technicien: </strong>""<h6>"+ jobprofile.user.full_name + "</h6>"  +"<strong>""Job of Technicien: ""</strong>"" <h6>" +  jobprofile.namejob +  " </h6>"  +"<strong>" "mobile :" "</strong>"" <h6>" +jobprofile.user.mobile.to_s  + " </h6>"  + "<strong>""Email :" "</strong>"" <h6>" +jobprofile.user.email + " </h6> "" <h6> " + "<a href='jobprofiles/#{jobprofile.id} '>Profiles of technicien</a>" +" </h6> "
